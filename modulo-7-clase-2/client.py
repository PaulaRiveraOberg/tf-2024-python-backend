...
import course_service_pb2 as CSpb2
import course_service_pb2_grpc as CSpb2_grpc
import delivery_service_pb2 as DSpb2
import delivery_service_pb2_grpc as DSpb2_grpc
import grpc
...
def course_saga():
    ...
    with grpc.insecure_channel("localhost:50051") as channel:
        ...
        DSmessage = DSpb2.DSCourseUser(
            ...
            user=DSpb2.DSUser(
                id="10101010-2", name="Clodomiro", email="clodo.silva@survival.com"
            ),
        )
