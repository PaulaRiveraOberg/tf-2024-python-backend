...
def update_book(isbn: str, book_data: dict):
    """
    Actualiza los datos de un libro dado su ISBN.

    Args:
        isbn (str): El ISBN del libro a actualizar.
        book_data (dict): Un diccionario con los nuevos datos del libro.
    ...
    Returns:
        dict: Un diccionario con los datos actualizados del libro.
    """
    validate_isbn(isbn)
...
def delete_book(isbn: str):
    ...
    Returns:
        dict: Un diccionario con los datos del libro eliminado.
    """
    validate_isbn(isbn)
    for i, book in enumerate(books):
        if book["isbn"] == isbn:
