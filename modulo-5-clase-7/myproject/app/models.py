...
class Curso(models.Model):
    ...
    codigo_curso = models.CharField(unique=True, max_length=10)
...
class Estudiante(models.Model):
    ...
    rut_estudiante = models.CharField(unique=True, blank=True, null=True, max_length=10)
    nombre_estudiante = models.CharField(max_length=100)
    fecha_nacimiento = models.DateField()
    direccion = models.CharField(blank=True, null=True, max_length=100)
    correo = models.CharField(blank=True, null=True, max_length=100)
...
class Relator(models.Model):
    ...
    rut_relator = models.CharField(unique=True, blank=True, null=True, max_length=10)
    nombre_relator = models.CharField(max_length=100)
    titulo_relator = models.CharField(blank=True, null=True, max_length=100)
