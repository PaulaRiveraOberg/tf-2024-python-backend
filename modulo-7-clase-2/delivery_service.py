...
import delivery_service_pb2 as pb2
import delivery_service_pb2_grpc as pb2_grpc
import grpc
...
class DeliveryServicer(pb2_grpc.DeliveryServiceServicer):
    ...
    def undeliver_course(self, request, context):
        print(
            "We're sorry, course undelivered! Contact your company for more information."
        )
